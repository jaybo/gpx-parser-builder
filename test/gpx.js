    ...
    describe("Parse", function () {
        it("Parse a gpx string", function (done) {
            fs.readFile("./test/test.gpx", function (err, data) {
                ...
                assert.equal(
                    gpx.metadata.extensions["gpxhb:postscript"],
                    "感謝老天賜予美好天氣，不過實在是熱到快中暑 😂"
                );
                ...
                assert.equal(gpx.trk[0].trkseg[0].trkpt[0].extensions["gpxhb:speed"], 0.98);
    ...
    describe("Build", function () {
        ...
        it("Namespaces", function (done) {
            const gpx = new GPX({
                ...
                metadata: {
                    name: "A DeepZoom Trip",
                    extensions: {
                      "deepzoom:trip" : "A DeepZoom Trip"
                    }
                },
                rte: {
                    name: "Route 1",
                    extensions: {
                        "opencpn:planned_speed": 5.0,
                        "opencpn:planned_departure": "2024-12-07T09:01-08:00",
                        "deepzoom:foo": "bar"
                    },
                    rtept: [
                        {
